...
public class InstructionScene extends Scene{
    ...
    public InstructionScene(Group layout2, double width, double height) {
        ...
        Image image;
        try {
            image = new Image(new FileInputStream("F:\\Project\\2-1 java\\2_1 project\\My project\\src\\instructionscene.gif")); //path of the image is given here for first scene;
